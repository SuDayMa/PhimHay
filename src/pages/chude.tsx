...
export default function Chude() {
  return (
    <div className="text-white bg-[#191B24] py-[90px]">
      <div className="mx-[330px] max-[2000px]:mx-[0px] px-[50px] max-[2000px]:px-[20px]">
        <div className="flex text-[28px] font-medium mb-[19px]">
          <h1>Các chủ đề</h1>
        </div>
        <div className="mt-[32px] grid grid-cols-7 max-[1441px]:grid-cols-6 max-[800px]:grid-cols-3 max-[500px]:grid-cols-2 gap-4">
          {DataChudes.map((chude) => (
            <a
              key={chude.id}
              className="py-[20px] pl-[25px] pr-[30px] rounded-xl hover:-translate-y-[10px] transition-all duration-300"
