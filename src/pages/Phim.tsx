...
export default function Phim() {
                ...
                <div className=" p-[40px] mx-[40px] rounded-4xl bg-[#21242e] ">
                                <div className="mb-[32px]">
                                    <div>
                                        ...
                                        <div className="px-[8px] border-1 border-[#ffff] rounded-md">
                                            <p className="text-[#ffff] text-[14px] font-extralight">{phim?.movie.year}</p>
                                        </div>
                                        {phim?.movie.tmdb.season && (
                                            <div className="px-[8px] border-1 border-[#ffff] rounded-md text-[#ffff]">
                                                Phần {phim?.movie.tmdb.season}
                                            </div>
                                        )}
                                        <div className="px-[8px] border-1 border-[#ffff] rounded-md">
                                            <p className="text-[#ffff] text-[14px] font-extralight">{phim?.movie.episode_current}</p>
                                        </div>

                                        </div>
                                        <div className="flex mb-[12px]">
                                            <div className="flex ">
                                                <p className="text-[#ffff] text-[14px] font-extralight flex gap-2">{phim?.movie.category.map((item, index) => (
                                        ...
                                        <div className="flex mb-[24px]">
                                            <div className="bg-yellow-700 p-[6px] rounded-md">
                                                <span className="text-[#ffff]">{phim?.movie.episode_current}/{phim?.movie.episode_total}</span>
                                            </div>
                                        </div>
                                        <div className="mb-[19px]">
                                            <div className="text-[#ffff] mb-[8px] font-semibold text-[18px]">
                                                Giới thiệu:
                                            </div>
                                        ...
                                        <div className="flex mb-[19px] gap-2 text-[#ffff] text-[14px]">
                                ...
                                <div className="mb-[32px] text-[#ffff]">
                                    ...
                                    <div>
                                        {phim?.movie.actor.map((item, index) => {
                                            return(
                                            <div key={index} className="text-[#ffff] bg-amber-300" >
                                                <span>{item.name}</span>
                                            </div>
                                            )})}
                                    </div>
    ...
    const loadingphim = (
        ...
        <div
            className="w-5 h-5 rounded-full animate-spin  border-3 border-solid border-[#ffff] border-t-transparent">
        </div>
    </div>
    )
    return (
                        ...
                        <div className=" mx-[330px] max-[2000px]:mx-[150px] px-[50px] max-[2000px]:px-[20px] flex  max-[1100px]:hidden">
                            <div className="w-[35%] p-[40px] rounded-4xl rounded-tr-[80px] bg-[#191B24]">
                                <div className="mb-[32px]">
                                    ...
                                    <h2 className="text-[#ffff] text-[20px] font-bold mb-[8px]">{phim?.movie.name}</h2>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex mb-[12px]">
                                            <div className="flex ">
                                                <p className="text-[#ffff] text-[14px] font-extralight flex flex-wrap gap-2">{phim?.movie.category.map((item, index) => (
                                        ...
                                        {phim?.movie.episode_current && (
                                            <div className="bg-yellow-700 p-[6px] rounded-md flex gap-1">
                                                ...
                                                <span className={`text-[#ffff]`}>{phim?.movie.episode_current}</span>
                                            </div>
                                        )}
                                        </div>
                                        <div className="mb-[19px]">
                            ...
                            <div className="w-[70%] p-[40px]  bg-[#191B24] rounded-[80px] ">
                                <div className="flex mb-[32px] border-b border-gray-600 pb-[32px]">
                                    {selectedServer && playmovie ? (
                                        ...
                                        <div className="text-[#ffff]">Chưa có tập nào </div>
                                    )}
                                </div>
                                <div>
                                    <div className="text-[#ffff] text-[28px] mb-[20px]">Tập Phim: </div>
                                    <div className="flex gap-4 mb-[20px]">
                                        {phim?.episodes.map((item) => (
                                            <button
                                                key={item.server_name}
                                                onClick={() => setSelectedServer(item.server_name)}
                                                className={`px-[16px] py-[8px] rounded-md ${ selectedServer === item.server_name? "bg-[#e4c36f] text-black": "bg-gray-700 text-[#ffff]"}`}>
                                                {item.server_name}
                                            </button>
                                            ))}
                                    </div>
                                                ...
                                                {item.server_data.map((server,indexs) => (
                                                    ...
                                                    <a key={indexs} className="p-[10px] m-[5px] bg-[#282B3A] rounded-md hover:bg-gray-600 transition-all justify-center gap-2 flex">
                                                        <span className="text-[#ffff]">
                                                            ...
                                                            <span className="text-[#ffff] text-[13px] flex justify-center items-center">
                                                                {server.name}
                                                            </span>
                            ...
                            <div className=" flex flex-col items-center justify-center ">
                                ...
                                <div className="mb-[25px]">
                                    {selectedServer && playmovie ? (
                                        ...
                                        <div className="text-[#ffff]">Không có tập phim nào để xem</div>
                                    )}
                                </div>
                                <div className="text-[#ffff] flex gap-5 mb-[30px]">
                                    ...
                                    <div className="flex gap-4 mb-[20px]">
                                        {phim?.episodes.map((item) => (
                                            <button
                                                key={item.server_name}
                                                onClick={() => setSelectedServer(item.server_name)}
                                                className={`px-[16px] py-[8px] rounded-md ${item.server_name ? "bg-[#e4c36f] text-black": "bg-gray-700 text-[#ffff]"}`}>
                                                {item.server_name}
                                            </button>
                                            ))}
                                    </div>
