        ...
        <div className="">
            ...
            <div className="flex flex-col gap-[50px] mt-[50px] mx-[330px] max-[2000px]:mx-[0px] px-[50px] max-[2000px]:px-[20px]">
                <div className=" px-[10px] h-full">
                    <div className="mb-[19px] flex text-[#ffff] text-[28px] font-bold max-[400px]:text-[20px]">
                    ...
                    <div className="grid grid-cols-7 justify-between gap-5 max-[426px]:gap-3 max-[1674px]:grid-cols-6 max-[1440px]:grid-cols-5 max-[1024px]:grid-cols-4 max-[789px]:grid-cols-3 ">
                        <a className="bg-blue-400 rounded-xl hover:-translate-y-[10px] transition-all duration-300">
                            ...
                            <div className=" flex pl-5 pr-10 py-5  h-full max-[600px]:px-2">
                                <div className="flex flex-col justify-end max-[600px]:justify-center w-full gap-3 h-full text-[#ffff]">
                        ...
                        <a className=" bg-[#409984] rounded-xl hover:-translate-y-[10px] transition-all duration-300 max-[789px]:hidden">
                            ...
                            <div className=" flex pl-5 pr-10 py-5 h-full">
                                <div className="flex flex-col justify-end w-full gap-3 h-full text-[#ffff]">
                        ...
                        <a className=" bg-[#525565] rounded-xl hover:-translate-y-[10px] transition-all duration-300 max-[1674px]:hidden">
                            ...
                            <div className=" flex p-8 h-full">
                                <div className="flex flex-col justify-center items-center w-full gap-5 h-full text-[#ffff]">
                                    <div className="text-[28px] max-[1360px]:text-[19px] max-[1441px]:text-[22px] font-bold">
                                        +4 Chủ Đề
                                    </div>
                                </div>
                ...
                <div className="min-[641px]:px-[50px]">
                    <div className="flex mb-[19px] text-[#ffff] text-[28px] max-[400px]:text-[23px] font-bold gap-5 items-center">
                        
                            <h2>Phim Lịch Sử</h2>
                            <Link to={"/the-loai/lich-su"}>
                            <div className=" rounded-full border-1 h-[30px] border-[#ffff] flex items-center justify-center">
                ...
                <div className="min-[641px]:px-[50px]">
                    <div className="flex mb-[19px] text-[#ffff] text-[32px] max-[400px]:text-[23px] font-bold gap-5 items-center">
