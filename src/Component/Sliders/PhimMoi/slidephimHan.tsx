...
import { MovieAPI, slidePhimQuocGia, PhimAPI } from '../../../Services/API';
...
export default function SlideImage() {
    ...
    useEffect(() => {
     ...
     const langPhim = phimHan?.data.items.find((item) => item.lang)
                        ...
                        <div className="flip-card3 ">
                            <div className="flip-card-inner3 duration-200">
                                ...
                                <div className="flip-card-back3 bg-[#2F3346]">
                                    ...
                                    <img src={`${phimHan.data.APP_DOMAIN_CDN_IMAGE}/${item.poster_url}`} className="w-full h-25 object-cover mask-b-from-10%" />
                                    
                                    <div className="flex flex-col h-full px-[7px]">
                                        <div className="">
                                            <Link 
                                                to={`/Player/${item.slug}/${encodeURIComponent(selectedServer ?? `${langPhim}`)}/${Typephim}`}
