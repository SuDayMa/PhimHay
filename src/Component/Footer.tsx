                ...
                <div className="py-[32px] flex">
                    <div className='w-[60%] max-[1100px]:w-[100%] max-[1100px]:flex max-[1100px]:flex-col max-[1100px]:items-center'>
                        <div className='mb-[24px] max-[1100px]:flex max-[1100px]:items-center max-[1100px]:justify-center'>
                            <div className=' bg-red-800 flex px-[10px] py-[8px] w-[50%] max-[2000px]:w-[50%] max-[1441px]:w-[60%] max-[1100px]:w-[35%] max-[800px]:w-[45%] max-[500px]:w-[90%] max-[400px]:w-[100%] max-[1100px]:text-[14px] rounded-3xl text-white '>
                                <img src={vn} alt="" className='w-[5%] '/>
                                <span className='pl-5 flex text-center'>Hoàng Sa & Trường Sa là của  Việt Nam!</span>
                            </div>
                        </div>
                        <div className='flex text-white mb-[32px] max-[1100px]:gap-8 max-[1100px]:flex-col max-[2000px]:w-[70%] max-[1441px]:w-[80%] max-[1100px]:w-[50%] max-[800px]:w-[70%] max-[500px]:w-[100%] max-[1100px]:items-center'>
                        ...
                        <div className='mb-[16px] flex text-white max-[590px]:text-[10px] max-[424px]:text-[8px] max-[370px]:text-[6px]'>
